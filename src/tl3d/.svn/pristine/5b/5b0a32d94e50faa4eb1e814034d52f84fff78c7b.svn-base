module tl3d {
    export class Context3D {
        ...
        public uploadBuff3D($jsData: any): WebGLBuffer {
            let arrayBuffer = this.renderContext.getParameter(this.renderContext.ARRAY_BUFFER_BINDING);
        ...
        public getTexture($img: any, $wrap: number = 0, $filter: number = 0, $mipmap: number = 0): WebGLTexture {
            ...
            //         let elementArrayBuffer  = this.renderContext.getParameter(this.renderContext.ELEMENT_ARRAY_BUFFER_BINDING);
            let text2DbIN = this.renderContext.getParameter(this.renderContext.TEXTURE_BINDING_2D);
