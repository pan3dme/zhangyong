module tl3d {
    export class ObjDataManager extends ResGC {
        ...
        public readFloatNrm(byte: TLByteArray, vertices: Array<number>): void {
        ...
        private readcollisionItem(byte: TLByteArray, $objData: ObjData): void {
            //将碰撞体都写入对象的OBJ对象中
        ...
        public loadObjCom($byte: ArrayBuffer, $url: string): ObjData {
            ...
            var byte: TLByteArray = new TLByteArray($byte);
        ...
        public readObj2OneBuffer(byte: TLByteArray, $objData: ObjData): void {
