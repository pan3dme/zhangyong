module tl3d {
    export class MeshDataManager extends ResGC {
        ...
        public getMeshData($url: string, $fun: Function, $batchNum: number = 1): void {
            ...
            this.loadRoleRes(Scene_data.fileRoot + $url, ($roleRes: RoleRes) => {
        ...
        public readData(byte, $batchNum, $url, $version): SkinMesh {
         ...
         private readBindPosByte(byte: TLByteArray): Array<Array<number>>  {
        ...
        public readMesh2OneBuffer(byte: TLByteArray, meshData: MeshData): void {
