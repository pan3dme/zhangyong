...
module tl3d {
    export class ArtFont {
        ...
        //英雄召唤新增
        public static num76: string = "NUM76";  //NUM
        public static num77: string = "NUM77";  //NUM
        public static num81: string = "NUM81";  //NUM
        ...
        private makeFontRect(): void {
            ...
            this.getXmlData(UIData.flytext);
            // console.log(this.fontData);
        }
        private getXmlData($key:string): void {
            // var obj: any = UIData.getUiByName(UIData.textlist, "A_txt1");
            var $uiList: Array<any> = UIData.getUiArrByKey($key);
        ...
        public writeFontToSkinName($UIAtlas: UIAtlas, $iconName: string, $str: string, $color: string = ArtFont.ORANGE_TXT, $textAlign: string = TextAlign.LEFT, $txtInterval: number = 0,$py:number = 0): number {
