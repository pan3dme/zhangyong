...
(function (layapan) {
    ...
    var Vector2D = tl3d.Vector2D;
    var Scene_data = tl3d.Scene_data;
    var MathClass = tl3d.MathClass;
    var TestTriangle = tl3d.TestTriangle;
    var LineDisplayShader = tl3d.LineDisplayShader;
    var LineDisplaySprite = tl3d.LineDisplaySprite;
    var CharAction = tl3d.CharAction;
    var LayaSceneChar = /** @class */ (function (_super) {
         ...
         * @param needFollow
         */
        LayaSceneChar.prototype.play = function ($action, $completeState, needFollow, cb) {
            ...
            if (this.isMount) {
                ...
                return _super.prototype.play.call(this, $action, $completeState, needFollow, cb);
            }
        };
        ...
        */
        ...
        LayaSceneChar.prototype.applyVisible = function () {
            ...
            if (this._partDic) {
                if (this._partDic[LayaSceneChar.MESH]) {
                    for (var _i = 0, _a = this._partDic[LayaSceneChar.MESH]; _i < _a.length; _i++) {
                        var obj = _a[_i];
        ...
        LayaSceneChar.prototype.setcharNameSize = function (size) {
            //字体只支持22字号以内
            this._charNameVo && (this._charNameVo.size = size);
        };
        //#000000 颜色和描边色
        LayaSceneChar.prototype.setcharNameColor = function (color, scolor) {
            if (scolor === void 0) { scolor = ''; }
        ...
        LayaSceneChar.prototype.math3DWorldtoDisplay2DPos = function ($pos) {
            var m = this._scene.cameraMatrix.clone();
        ...
        LayaSceneChar.prototype.mouseClik = function (lineA, $lineB) {
            var $pos = this._scene.cameraMatrix.transformVector(this.getCurrentPos());
            if ($pos.z < 10) { //在Z后面
                return false;
            }
