...
(function (tl3d) {
    var UIAtlas = /** @class */ (function () {
        ...
        UIAtlas.prototype.updateLable = function ($key, $str, fontsize, fontColor, textBaseline, textAlign, bolder, maxWidth) {
            if (textBaseline === void 0) { textBaseline = tl3d.TextAlign.MIDDLE; }
            if (textAlign === void 0) { textAlign = tl3d.TextAlign.CENTER; }
        ...
        UIAtlas.prototype.writeSingleLabelToCxt = function ($ctx, $str, fontsize, $tx, $ty) {
            ...
            if ($tx === void 0) { $tx = 0; }
            if ($ty === void 0) { $ty = 0; }
            $ctx.textBaseline = tl3d.TextAlign.TOP;
            $ctx.textAlign = tl3d.TextAlign.LEFT;
