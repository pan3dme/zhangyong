...
(function (tl3d) {
    var Display3DFacetParticle = /** @class */ (function (_super) {
        ...
        Display3DFacetParticle.prototype.updateUV = function () {
            var currentFrame = float2int(this._time / tl3d.Scene_data.frameTime);
            ...
            this._resultUvVec[0] = float2int(currentFrame % this.data._animLine) / this.data._animLine + this._time / tl3d.Scene_data.frameTime * this.data._uSpeed;
            this._resultUvVec[1] = float2int(currentFrame / this.data._animLine) / this.data._animRow + this._time / tl3d.Scene_data.frameTime * this.data._vSpeed;
        };
