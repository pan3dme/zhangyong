...
var common;
(function (common) {
    var CommonTitle7View = /** @class */ (function (_super) {
        __extends(CommonTitle7View, _super);
        function CommonTitle7View() {
            var _this = _super.call(this) || this;
            _this.btnClose.on(Laya.Event.CLICK, _this, _this.onClick);
            _this.setTitleVisible(false);
            return _this;
        }
        Object.defineProperty(CommonTitle7View.prototype, "dataSource", {
            get: function () {
        ...
        CommonTitle7View.prototype.refreshData = function () {
        ...
        /** 更新标题 */
        CommonTitle7View.prototype.updateTitle = function (title) {
            var data = this.dataSource;
            if (data) {
                data.title = title;
            }
        ...
        CommonTitle7View.prototype.setTitleVisible = function (visible) {
            this.bgTitle.visible = this.lbTitle.visible = visible;
        };
        CommonTitle7View.prototype.onClick = function () {
        ...
        return CommonTitle7View;
    }(ui.component.CommonTitle7UI));
    common.CommonTitle7View = CommonTitle7View;
})(common || (common = {}));
