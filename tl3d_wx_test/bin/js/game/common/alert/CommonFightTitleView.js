...
var common;
(function (common) {
    var CommonFightTitleView = /** @class */ (function (_super) {
        __extends(CommonFightTitleView, _super);
        function CommonFightTitleView() {
            ...
            */
            ...
            _this._isShowHg = false;
            _this._isShowLight = false;
            _this._isNoClose = false;
            _this._step = 0;
            _this._cdTime = 0;
            _this.closeTitle();
            return _this;
        }
        CommonFightTitleView.prototype.showTitle = function (isWin, titleSkin, showStar, showHg, showLight, callback, tparent, noClose) {
            if (showStar === void 0) { showStar = true; }
            if (showHg === void 0) { showHg = true; }
            if (showLight === void 0) { showLight = true; }
            if (callback === void 0) { callback = null; }
            if (tparent === void 0) { tparent = null; }
            if (noClose === void 0) { noClose = true; }
            ...
            if (noClose) {
                var tp = (tparent || this.parent);
                if (tp)
                    tp.isModelClose = false;
            }
        ...
        CommonFightTitleView.prototype.update = function () {
            if (this._isWin) {
                this._cdTime -= 30;
                if (this._cdTime <= 0) {
        ...
        CommonFightTitleView.prototype.endUpdate = function () {
            if (this._isNoClose) {
                var tp = (this._titleparent || this.parent);
                if (tp)
                    tp.isModelClose = true;
            }
            if (this._callBack) {
                this._callBack.run();
                this._callBack = null;
        ...
        CommonFightTitleView.prototype.closeTitle = function (force) {
        ...
        return CommonFightTitleView;
    }(ui.component.CommonFightTitleUI));
    common.CommonFightTitleView = CommonFightTitleView;
})(common || (common = {}));
