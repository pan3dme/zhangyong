...
class utils {
    ...
    public static getMsgValue = function (msg, dsName) {
        if (msg && dsName) {
    ...
    public static handleForChgVal(obj, ruleName) {
        if (!obj) {
            return null;
        }
        var temp, value;
    ...
    //复制字节数组
    public static copyArray(dest, doffset, src: Laya.Byte | ArrayBuffer, soffset, length) {
