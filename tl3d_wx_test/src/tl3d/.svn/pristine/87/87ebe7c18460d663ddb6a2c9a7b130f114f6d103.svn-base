module tl3d {
    export class ParticleData {
        ...
        public setAllByteInfo($byte: TLByteArray): void {
        ...
        private readMaterialPara($byte: TLByteArray): void {
        ...
        private readTempCurve($byte: TLByteArray, curve: any): void {
        ...
        private readItems($byte: TLByteArray): Array<any> {
        ...
        private readMaterialParaConAry($byte: TLByteArray): void {
