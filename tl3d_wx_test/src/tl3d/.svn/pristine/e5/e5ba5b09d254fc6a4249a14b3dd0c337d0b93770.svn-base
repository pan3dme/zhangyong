    ...
    export class AnimManager {
        ...
        public getAnimData($url: string, $fun: Function): void {
            ...
            LoadManager.getInstance().load($url, LoadManager.BYTE_TYPE, ($byte: ArrayBuffer, _fun: Function) => {
                ...
                var animData: AnimData = this.readData(new TLByteArray($byte), $url);
                _fun(animData);
            }, $fun);
        ...
        public readData(byte: TLByteArray, $url): AnimData {
        ...
        private readFrameData(byte: TLByteArray, frameAry: Array<Array<number>>): void {
        ...
        private readFrameTypeData(byte: TLByteArray): Array<boolean> {
