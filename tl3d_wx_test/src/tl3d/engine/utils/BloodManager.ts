...
module tl3d {
    export class TextJumpType {
        ...
        public static N_NORMALDAMAGE: number = 16;//普通伤害16+60 76
        public static N_CRIT: number = 17;//暴击 17+60 77
        public static N_RESISTANCE: number = 18;//抵抗 
        public static N_RESISTANCES: number = 181;//抵抗 
        public static N_IMMUNE: number = 19;//免疫
        public static N_ONCEATTACK: number = 20;//追加回合
        public static N_PASSIVE: number = 21;//被动技能 21+60 81
        public static N_RESURGENCE: number = 22;//复活
        public static N_UPHP: number = 23;//回血 23+60 83
        public static N_BEATBACK: number = 24;//反击 
        public static N_DOWNHP: number = 25;//无法回血 
        public static N_BOMB: number = 26;//炸弹 
        public static N_DIZZY: number = 27;//晕眩 
        public static N_INVINCIBLE: number = 28;//无敌 
        public static N_TARGET: number = 29;//标记
        public static N_SARCASM: number = 30;//嘲讽
        public static N_SILENCE: number = 31;//沉默
        public static N_SHIELD: number = 32;//护盾
        public static N_BLEED: number = 33;//流血
        public static N_SLEEP: number = 34;//沉睡
        public static N_CRIT_RATE_UP: number = 35;//暴击率+ 
        public static N_RESIST_RATE_UP: number = 36;//抵抗+ 
        public static N_ATTACK_UP: number = 37;//攻击+
        public static N_DEFENSE_UP: number = 38;//防御+
        public static N_SPEED_UP: number = 39;//攻速+
        public static N_HIT_UP: number = 40;//命中+
        public static N_CRIT_RATE_DOWN: number = 41;//暴击率- 
        public static N_RESIST_RATE_DOWN: number = 42;//抵抗- 
        public static N_ATTACK_DOWN: number = 43;//攻击-
        public static N_DEFENSE_DOWN: number = 44;//防御-
        public static N_SPEED_DOWN: number = 45;//攻速-
        public static N_HIT_DOWN: number = 46;//命中-


        public static N_SHIHUA: number = 47;//石化
        public static N_MEIHUO: number = 48;//魅惑
        public static N_SHUFU: number = 49;//束缚
        public static N_BINGFENG: number = 50;//冰封
        public static N_ZHONGDU: number = 51;//中毒
        public static N_LEIDIAN: number = 52;//雷电
        public static N_ANGER_DOWN: number = 53;//减怒
        public static N_WANGLING: number = 54;//亡灵
        public static N_MABI: number = 55;//麻痹
        public static N_FENNU: number = 56;//愤怒
        public static N_FANTAN: number = 57;//反弹
        public static N_SHARE: number = 58;//分摊
        public static N_ZHUOSHAO: number = 59;//灼烧
    }
    ...
    export class ExpTextJumpUiDrawAndRefreash extends Disp2DBaseText {
        ...
        public update(): void {
            if (this._data) {
                ...
                (<AlphaUICompenent>this.ui).alpha = $ary[4];//alpha
            }
        }
