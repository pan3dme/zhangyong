module tl3d {
    export class SceneManager {
        ...
        public bloodMgr: BloodManagerExt;
        ...
        public loadSceneConfigCom2(obj: any): void {
            this._sceneDic = new Object();
        ...
        */
        ...
        public changeBloodManager($bloodManager:BloodManagerExt): void {
        ...
        public loadSceneConfigCom(obj: any): void {
            ...
            Scene_data.focus3D.rotationY = Scene_data.focus3D.rotationY;
        ...
        public charPlaySkill($char: Display3dMovie, $skillfile: string,$skilleff:string = "skill_01",$cb:Function = null): Skill {
            ...
            var $skill: Skill = this.skillMgr.getSkill(getSkillUrl($skillfile), $skilleff);
            if (!$skill.keyAry) {
                return;
            }
            if ($skill) {
