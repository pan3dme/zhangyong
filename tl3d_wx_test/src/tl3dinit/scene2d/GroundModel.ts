module scene2d {
    ...
    export class Ground2dBaseShader extends tl3d.Shader3D {
    ...
    export class Ground2dBaseSprite extends tl3d.Display3D {
        ...
        private loadTexture(): void {
            var $ctx: CanvasRenderingContext2D = tl3d.UIManager.getInstance().getContext2D(128, 128, false);
        ...
        public setPicUrl($url: string): void {
          //  var $url: string = Scene_data.fileRoot + "pan/zymap2d/scene/1007/maps/0_0.jpg"
            tl3d.TextureManager.getInstance().getTexture($url, ($texture: tl3d. TextureRes) => {
                this._uvTextureRes = $texture;
            });
        }
        public _uvTextureRes: tl3d.TextureRes
        ...
        public static perentpos: tl3d.Vector2D = new tl3d.Vector2D()
    ...
    export class GroundModel {
        ...
        public addGroundPicByeUrl($url: string = null, $rect: tl3d.Rectangle = null): Ground2dBaseSprite {
