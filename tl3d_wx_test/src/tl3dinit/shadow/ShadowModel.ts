...
module shadow {
    ...
    import SceneManager = tl3d.SceneManager
    import Engine = tl3d.Engine
    ...
    export class ShadowModel {
        ...
        public updateDepth($scene: tl3d.SceneManager): void {
            ...
            var $cloneVp: tl3d.Matrix3D = Scene_data.vpMatrix.clone();
            var $cloneView: tl3d.Matrix3D = Scene_data.viewMatrx3D.clone();
